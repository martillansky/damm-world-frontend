...
import type { VaultForked, VaultForkedInterface } from "../VaultForked";
...
export class VaultForked__factory {
  static readonly abi = _abi;
  static createInterface(): VaultForkedInterface {
    return new utils.Interface(_abi) as VaultForkedInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VaultForked {
    return new Contract(address, _abi, signerOrProvider) as VaultForked;
  }
}

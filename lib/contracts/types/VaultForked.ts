...
export interface VaultForkedInterface extends utils.Interface {
  functions: {
    ...
    "claimSharesOnBehalf(address[])": FunctionFragment;
    ...
    "expireTotalAssets()": FunctionFragment;
    ...
    "isTotalAssetsValid()": FunctionFragment;
    ...
    "syncDeposit(uint256,address,address)": FunctionFragment;
    ...
    "updateTotalAssetsLifespan(uint128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "claimSharesOnBehalf",
    values: [string[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "expireTotalAssets",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "isTotalAssetsValid",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateTotalAssetsLifespan",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "DepositSync(address,address,uint256,uint256)": EventFragment;
    ...
    "TotalAssetsLifespanUpdated(uint128,uint128)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DepositSync"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TotalAssetsLifespanUpdated"): EventFragment;
...
export interface DepositSyncEventObject {
  sender: string;
  owner: string;
  assets: BigNumber;
  shares: BigNumber;
}
export type DepositSyncEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  DepositSyncEventObject
>;

export type DepositSyncEventFilter = TypedEventFilter<DepositSyncEvent>;
...
export interface TotalAssetsLifespanUpdatedEventObject {
  oldLifespan: BigNumber;
  newLifespan: BigNumber;
}
export type TotalAssetsLifespanUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber],
  TotalAssetsLifespanUpdatedEventObject
>;

export type TotalAssetsLifespanUpdatedEventFilter =
  TypedEventFilter<TotalAssetsLifespanUpdatedEvent>;
...
export interface VaultForked extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VaultForkedInterface;
  ...
  functions: {
    ...
    isTotalAssetsValid(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    expireTotalAssets(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "DepositSync(address,address,uint256,uint256)"(
      sender?: string | null,
      owner?: string | null,
      assets?: null,
      shares?: null
    ): DepositSyncEventFilter;
    DepositSync(
      sender?: string | null,
      owner?: string | null,
      assets?: null,
    ...
    "TotalAssetsLifespanUpdated(uint128,uint128)"(
      oldLifespan?: null,
      newLifespan?: null
    ): TotalAssetsLifespanUpdatedEventFilter;
  ...
  estimateGas: {
    ...
    isTotalAssetsValid(overrides?: CallOverrides): Promise<BigNumber>;
